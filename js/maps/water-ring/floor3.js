WaterRingF3 = function(game){

};

WaterRingF3 = {
    preload: function(){
        this.load.tilemap('map', 'js/maps/water-ring/floor3.json', null, Phaser.Tilemap.TILED_JSON);
    ...
    update: function(){
        ...
        if(786 >= spriteAlex.body.x - 20 && 786 <= spriteAlex.body.x + 20 && 1565 <= spriteAlex.body.y && 1565 >= spriteAlex.body.y - 10){
            ...
            this.state.start('WaterRingBoss');
        }
